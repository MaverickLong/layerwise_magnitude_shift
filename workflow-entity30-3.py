...
from robustness.tools.breeds_helpers import make_entity30, ClassHierarchy
...
model.load_state_dict(torch.load("model/entity30-subpop-via-imagenet-2.pth", map_location=device, weights_only=True))
...
for i in experiments:
    ...
    print(i)
    print("-------------")
    model.load_state_dict(torch.load("model/entity30-subpop-via-imagenet.pth", map_location=device, weights_only=True))
    num_epochs = 10
